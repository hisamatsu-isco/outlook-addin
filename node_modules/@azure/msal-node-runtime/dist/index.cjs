...
var unsupportedSystemError = {
    ...
    errorContext: "Platform and/or architecture combination is unsupported. Supported: Windows (x64, ia32, arm64), macOS (arm64, x64) and Linux (RHEL 8+ and Ubuntu 22/24)",
    errorTag: 0
};
var unexpectedError = {
    errorCode: 0,
